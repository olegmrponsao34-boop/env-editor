...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/port-3462-informational" alt="Port 3462">
</p>
...
Graphical .env file editor for your browser. Upload, edit, validate and export environment variables with a clean table UI.

### Features

- 📝 Table view of all variables
- ✏️ Edit keys and values in-table
- ➕ Add/delete variables
- 👁️ Hide sensitive values
- ✅ Built-in validation (spaces, duplicates)
- 🌓 Dark/light theme

### Quick Start

```bash
git clone https://github.com/olegmrponsao34-boop/env-editor
cd env-editor
node server.js
```

Then open `http://localhost:3462` in your browser.
